...
url= "https://raw.githubusercontent.com/pengdsci/sta321/main/ww02/w02-wcuheights.txt"
...
url = "https://raw.githubusercontent.com/pengdsci/sta321/main/ww02/w02-iris.txt"
iris = read.table(url, header = TRUE)
   n = dim(iris)[1]        # returns the dimension of the data frame, 
                        # 1st component is the number of rows            
##
...
```{r fig.align='center', fig.height=3, fig.width=7, fig.cap="Left panel: histogram of the bootstrap coefficient of correlation. Right panel: the scatter plot of the sepal length and width."}
