...
The "**frequency**" is the number of observations per "cycle" (normally a year, but sometimes a week, a day, an hour, etc). When using the ts() function in R, the following choices should be used.
