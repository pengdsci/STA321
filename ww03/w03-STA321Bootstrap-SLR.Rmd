...
```{r echo = FALSE, fig.align='center', fig.width=7, fig.height=5, fig.cap="Property locations"}
library(leaflet)
m <- leaflet() %>%
...
```{r fig.align='center'}
pairs(realestate[, -c(1,5,6)], main ="Pair-wise Association: Scatter Plot")
```
...
<font color = "darkred" size = 5><b> The pair-wise scatter plot is used only for numerical variables to display the relationship between them! Categorical variables (including numerically encoded ones)!</b></font>
