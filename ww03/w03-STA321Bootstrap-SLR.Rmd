...
```{r echo = TRUE, fig.align='center', fig.width=8, fig.height=5, fig.cap="Property locations"}
library(leaflet)
m <- leaflet() %>%
...
```{r fig.align='center', fig.width=5, fig.height=5, fig.cap="Bos-cox transformation"}
boxcox(lm(price ~ distance), lambda = seq(-.2, .5, 1/10))
```
