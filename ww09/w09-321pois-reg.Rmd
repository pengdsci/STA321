...
The resulting logistic regression model can be used for association analysis and prediction as well. The use of predictive modeling is one of the most important classification algorithms in data science.
...
The regression model based on the cancer count is not appropriate since the information on the population size can not be used. Simply include the population size in the regression model to improve the model performance. See the following output of the fitted Poisson regression model.
