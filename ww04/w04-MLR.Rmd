...
<font color = "red">**\color{red}CAUTION**: *\color{red}SSE, AIC, SBC, and PRESS are dependent on the magnitude of the response. $R^2$, $R^2_{adj}$, and $C_p$ are scaled (index-like measure) and therefore independent on the magnitude of Response. Therefore, models with transformed response and those with the original magnitude can NOT be compared using SSE, AIC, SBC, and PRESS!*</font>  

<font color = "blue">**\color{blue}In the following table, three models have different magnitude due to transformations, the valid goodness of fit measures are $R^2$ and $C_p$!**</font>
