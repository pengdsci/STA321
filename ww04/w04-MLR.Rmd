...
# Case Study -Factors That Impact the House Sale Prices
...
```{r echo=FALSE, fig.align ="center", fig.cap="Locations of houses for sale", fig.height=4,fig.width=4, dev="jpeg"}
