...
**Test the hypothesis that Distance2MRT is NEGATIVELY associated with PriceUnitArea**
...
$$
H_0: \beta_4 \le 0  \  \  \text{ versus } \ \ H_a: \beta_4 > 0
$$

This is **right-tailed** test! The rejection region is on the right tail of the density curve.  How to calculate the p-value? 
...
$$
\text{p-value} = P(TS > t_{414 -5})  = 0.5021518
$$
...
Since the p-value is $p \approx 0.5021518$, we fail to reject the null hypothesis that the distance between the transportation center and the house price are negatively associated.
